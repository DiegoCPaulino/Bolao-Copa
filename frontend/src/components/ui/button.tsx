...
// Componente Button do shadcn/ui (estilo "new-york", tema neutral). Gerado pelo padrão
// do shadcn — os próximos componentes entram via `npx shadcn@latest add <nome>` quando
// uma tela precisar (sem instalar tudo especulativamente).
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold text-gold-foreground shadow-xs hover:bg-gold/90 active:bg-gold/80",
